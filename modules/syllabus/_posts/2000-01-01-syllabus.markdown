...
Objetivos: Este módulo hace un repaso sobre  el principio de “neutralidad de la red” que cada vez cobra más relevancia. Además analizará los debates en torno a este tema, así como su impacto global en áreas como desarrollo económico, derechos humanos y la gobernanza de Internet. Al término de este módulo, usted deberá contar con los recursos necesarios para responder las siguientes preguntas:
...
Objetivos: Este módulo abordará uno de los aspectos más contemporáneos para los defensores del interés público y de los derechos digitales: el impacto de los acuerdos comerciales sobre los temas de Internet Libre y Abierto, incluyendo aspectos como  la ciber-seguridad, una protección balanceada de la propiedad intelectual y los derechos humanos que mencionamos en los Módulos 6 y 9. Al término de este módulo, usted deberá contar con los recursos necesarios para responder las siguientes preguntas:
...
OBJETIVOS:  Este módulo servirá como introducción a la ciberseguridad o seguridad cibernética enfocándose particularmente en el aspecto de formulación de políticas sobre ciberseguridad, esto incluye como se aborda la ciberseguridad en las relaciones internacionales y el impacto que tiene la ciberseguridad en los derechos humanos. Para el final del módulo, usted debe ser capaz de responder las siguientes preguntas:
<ul><li>¿Qué roles juegan las distintas definiciones de seguridad cibernética en los debates, discusiones y toma de decisiones de políticas?
<li>¿Cuáles son las preocupaciones principales de derechos humanos cuando se aborda la seguridad cibernética?
<li>¿Existen normas internacionales y estándares que apliquen a la ciberseguridad? ¿En caso afirmativo, incluyen estas las preocupaciones relacionadas con derechos humanos?
